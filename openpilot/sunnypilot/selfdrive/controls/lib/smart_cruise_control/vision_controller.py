...
# how this car is actually driven here. Measured over 23 seg of hill road (one logged route, SCC-V
...
# 6-8 s chains of bends on local prefectural mountain routes, taken at a near-constant
...
# to brake (logged example, a right-angle rural junction: entering fired 4.4 s early, actual decel -0.1).
